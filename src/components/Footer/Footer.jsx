    ...
    return (
        <div className='bg-[#244D3F]'>
            <footer className="footer footer-horizontal footer-center  text-primary-content p-10">
                ...
                <div className="border-t border-white/10 w-[80%] my-4"></div>
                <div className='flex flex-col md:flex-row items-center justify-between gap-4 md:gap-60 text-xs'>
                     <p>© {new Date().getFullYear()} Keen Keeper - All right reserved</p>
